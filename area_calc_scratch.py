...
regions = r"H:\GIS\BWC_base_files\BWC_base_files.gdb\boundaries\ENRITI_AdministrativeRegions_incl_Gw_YT" # Admin or land claims. Can overlap. Shouldn't.
regions_name_field = "REGION"
areas = r"H:\Boreal_Caribou_Range_Plan\GIS\Habitat_protection_NWT_for_NT1\analyzed_data\areas_1.gdb\conservation_areas_CAM_scratchedit" # Such as "protected" and "conservation" areas. Could also iterate through several individual protected areas.
areas_field = "ZoneName" # Names of the specific areas.
...
out_csv = os.path.join(output_location, "out_table.csv")
